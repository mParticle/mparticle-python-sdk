...
class CommerceEvent(object):
    ...
    """
    def __init__(self, timestamp_unixtime_ms=None, event_id=None, source_message_id=None, session_id=None, session_uuid=None, custom_attributes=None, location=None, device_current_state=None, product_action=None, promotion_action=None, product_impressions=None, shopping_cart=None, currency_code=None, screen_name=None, is_non_interactive=None):
        """
